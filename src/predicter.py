...
def predict_from_all():
        ...
        prediction = np.load(open("../predictions/resnet50_retrain_predictions.npy"))
        data = np.column_stack((data,predictions))
        prediction = np.load(open("../predictions/vgg16_retrain_predictions.npy"))
        data = np.column_stack((data,predictions))
        prediction = np.load(open("../predictions/inceptionv3_retrain_predictions.npy"))
        data = np.column_stack((data,predictions))
        prediction = np.load(open("../predictions/resnet50_untrained_predictions.npy"))
        data = np.column_stack((data,predictions))
        prediction = np.load(open("../predictions/vgg16_untrained_predictions.npy"))
        data = np.column_stack((data,predictions))
        prediction = np.load(open("../predictions/inceptionv3_untrained_predictions.npy"))
        data = np.column_stack((data,predictions))
