...
weights_path = "../weights/inceptionv3_untrained.h5"
model_path = "../models/inceptionv3_untraineded.h5"
img_height = 300
img_width = 400
...
np.save(open('../predictions/inceptionv3_untrained_predictions.npy', 'w'), predictions)
